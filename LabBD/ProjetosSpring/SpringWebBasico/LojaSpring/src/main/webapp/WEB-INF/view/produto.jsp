		...
		<form action="produto" method="post">
			<table>
				...
				<tr>
					<td colspan="3">
						<input type="number"
						id="valor" name="valor" step="0.01" placeholder="Valor"
				...
				<tbody>
					<c:forEach var="p" items="${produtos}">
						<tr>
							...
							<td>${p.nome}</td>
							<td>${p.valor}</td>
							<td><a href="produto?acao=editar&codigo=${p.codigo}">EDITAR</a></td>
							<td><a href="produto?acao=excluir&codigo=${p.codigo}">EXCLUIR</a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
