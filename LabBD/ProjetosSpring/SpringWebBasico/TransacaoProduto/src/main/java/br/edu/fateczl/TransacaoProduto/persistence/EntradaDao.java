...
@Repository
public class EntradaDao implements ICrud<Transacao>{
	...
	public Transacao buscar(Transacao transacao) throws SQLException, ClassNotFoundException {
		...
		String sql = "SELECT Codigo_Transacao, Codigo_Produto, Quantidade, Valor_Total FROM Entrada WHERE Codigo_Transacao = ?";
