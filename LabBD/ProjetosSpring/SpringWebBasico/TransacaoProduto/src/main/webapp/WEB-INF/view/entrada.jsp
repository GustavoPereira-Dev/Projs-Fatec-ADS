...
<title>Cadastro Entrada Transacao</title>
</head>
<body>
	<div align="center">
	...
	<div class="conteiner" align="center">
		<h1>Cadastro de Entradas de Transacoes</h1>
		<br />
				...
				<tbody>
					<c:forEach var="t" items="${transacoes}">
						<tr>
							...
							<td>${t.quantidade}</td>
							<td>${t.valorTotal}</td>
							<td><a href="entrada?acao=editar&codigo=${t.codigo}">EDITAR</a></td>
							<td><a href="entrada?acao=excluir&codigo=${t.codigo}">EXCLUIR</a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
